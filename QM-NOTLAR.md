...
- **ŞIMDILIK (EJDER "legali şimdilik öyle yap, sonra CSV olacak hepsi"):** 03.7 ELLE giriş kalıyor (hücreye yaz→kaydol). Otomatik çekme (OCR/CSV) SONRAKI faz — panelde zaten AI görsel-okuma + "legal Sonnet" modu var (QM523), ileride ona bağlanacak. Şimdilik build etme.
